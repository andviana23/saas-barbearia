      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="h6" color="text.secondary">
            {agendamento.cliente.nome} • {agendamento.dataHora}
          </Typography>
        </Box>
      </Box>
            ...
            <CardContent>
              ...
              <List>
                {timelineEvents.map((event, index) => (
                  <ListItem key={index} sx={{ display: 'flex', alignItems: 'flex-start', px: 0 }}>
                    <ListItemIcon sx={{ minWidth: 40, mt: 0.5 }}>
                      <Avatar sx={{ bgcolor: `${event.color}.main`, width: 32, height: 32 }}>
                        {event.icon}
                      </Avatar>
                    </ListItemIcon>
                    <ListItemText

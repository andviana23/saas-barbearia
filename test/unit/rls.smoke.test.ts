...
// Smoke test RLS (simulado): garante que queries são sempre filtradas por unidade
// Aqui usamos mock Supabase e verificamos que actions aplicam eq('unidade_id' | 'unit_id', <id>)
...
describe('RLS smoke (simulado)', () => {
  test('actions aplicam filtros de unidade', async () => {
